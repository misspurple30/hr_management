...
const Sidebar = ({ isOpen, toggleSidebar }: SidebarProps) => {
  ...
  return (
    <>
      <aside 
        className={`w-64 bg-white border-r border-gray-200 flex flex-col fixed top-0 left-0 h-screen z-30
      ...
      >
        <div className="flex items-center justify-between p-6">
          ...
          <button onClick={toggleSidebar} className="lg:hidden p-1 text-gray-600 hover:text-red-600">
            <IoClose size={24} />
          </button>
        </div>
